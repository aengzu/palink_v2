...
class _CharacterApi implements CharacterApi {
  ...
  Future<CharactersResponse> getAllCharacters() async {
    ...
    final _value = CharactersResponse.fromJson(_result.data!);
    return _value;
  }

  @override
  Future<CharacterResponse> getCharacterById(int characterId) async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
    const Map<String, dynamic>? _data = null;
    ...
    final _value = CharacterResponse.fromJson(_result.data!);
    return _value;
  }
