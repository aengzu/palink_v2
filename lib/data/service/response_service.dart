  ...
  factory ResponseService.initialize() {
    ...
    final chatChain = ConversationChain(
      ...
      prompt:
        ...
        - isEnd : 만약 user의 마지막 말 또는 지난 대화에 부탁에 대한 수락(승낙)이 있다면 반드시  isEnd 를 바로 true로 설정하시오.(ex) 알았어 도와줄게, 그래 나한테 맡겨, 알았어 내가 할게 등) 그게 아니라면 default 값은 false 입니다. 만약 isEnd 가 false 이라면 물러서지 않고 계속 부탁합니다.(bool)
        ...
        - 사용자가 부탁을 수락하거나(ex) 알았어 내게 맡겨, 내가 도와줄게) 전체 대화 기록의 흐름이 '부탁'과 '부탁거절'에서 벗어난다면 isEnd 를 true 로 설정한다. (ex) 나랑 사귈래? 등)
