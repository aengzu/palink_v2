...
class ConversationAnalysisService {
 ...
 {chatHistory}
  ...
  [대화 상대의 성격]
  - 대화 상대가 진혁이라면 상대의 감정을 고려하기 보다는 자신의 의사를 명확히 표현해야하며 사용자가 저자세 거절을 한다면 이를 지적합니다, 대화 상대가 미연이라면 상대방의 감정을 고려하며 거절해야합니다. 세진이라면 거절의 이유를 명확히 표현해야하며 현아라면 집요한 요청에 대해 단호하게 거절해야합니다.
  {description}
