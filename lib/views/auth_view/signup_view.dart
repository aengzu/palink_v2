...
class SignupView extends StatelessWidget {
                ...
                children: [
                  ...
                  Row(
                    children: [
                      ...
                      Expanded(
                        child: _buildTextField(
                          controller: signUpController.personalityTypeController,
                          labelText: 'MBTI',
  ...
  Future<void> _signUp() async {
    await signUpController.signUp(
      ...
      int.parse(signUpController.ageController.text), // Ensure age is parsed as int
    ...
    return Column(
      ...
      children: [
        ...
        TextField(
          ...
          inputFormatters: inputFormatters, // Apply input formatters if any
