...
import 'package:palink_v2/views/chatting_view/componenets/liking_bar.dart';
import 'package:palink_v2/views/components/appbar_perferred_size.dart';
import 'package:palink_v2/views/components/custom_btn.dart';
import 'package:palink_v2/views/components/custom_button_lg.dart';
import 'package:palink_v2/views/main_screens.dart';
import 'package:sizing/sizing.dart';
import '../../../controller/conversation_end_controller.dart';
import '../chatting_view/componenets/chat_bubble.dart';
          ...
          if (result.isEmpty) {
            ...
            return Container(
              ...
              child: Column(
                ...
                children: [
                  Text('평가', style: TextStyle(fontSize: 22, fontWeight: FontWeight.bold)),
                  ...
                  if (result['evaluation'] is Map)
                    ...
                    Row(mainAxisAlignment: MainAxisAlignment.center, children: [_buildProfileImage(), Container(padding: EdgeInsets.all(15.0), width: 0.5.sw, color: AppColors.lightBlue, child: Text(result['evaluation'].toString()),)]),
                  SizedBox(height: 0.05.sh),
                  Text('최종 호감도', style: TextStyle(fontSize: 18, fontWeight: FontWeight.bold)),
                  SizedBox(height: 10),
                  LikingBar(controller.likingLevel.value as int),
                  Text('최종 호감도 ${controller.likingLevel.value}점'), // RxInt의 값 접근
                  SizedBox(height: 0.05.sh),
                  Text('사용한 거절 방법', style: TextStyle(fontSize: 18, fontWeight: FontWeight.bold)),
                  SizedBox(height: 10),
                  if (result['used_rejection'] is Map)
